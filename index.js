...
function uhr9() {
  document.getElementById("uhr9").style.width = "500px";
  document.getElementById("uhr9").style.height = "500px";
}
function uhrback9() {
  document.getElementById("uhr9").style.width = "250px";
  document.getElementById("uhr9").style.height = "250px";
}

function uhr10() {
  document.getElementById("uhr10").style.width = "500px";
  document.getElementById("uhr10").style.height = "500px";
}
function uhrback10() {
